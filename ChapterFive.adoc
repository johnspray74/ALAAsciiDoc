...
image::CalculatorRequirements.png[Calculator3.png, 900, title="Calculator requirements", link=images/CalculatorRequirements.png]


Here is a screenshot of the working calculator as it was two half-days later:

image::CalculatorScreenshot.png[CalculatorScreenshot.png, 900, title="Calculator screenshot", link=images/CalculatorScreenshot.png]
...
image::Calculator2Rows-HandDrawing.png[Calculator2Rows-HandDrawing.png, 900, title="Calculator (2 Rows only shown)", link=images/Calculator2Rows-HandDrawing.png]
...
image::CalculatorDomainAbstractionsHandDrawings.png[CalculatorDomainAbstractionsHandDrawings.png, 300, title="Calculator Domain Abstractions", link=images/CalculatorDomainAbstractionsHandDrawings.png]
...
image::CalculatorRow-GALADE.png[CalculatorRow-GALADE.png, 800, title="CalculatorRow abstraction internal wiring", link=images/CalculatorRow-GALADE.png]
...
image::CalculatorXmindParserTool.png[CalculatorXmindParserTool.png, 800, title="XmindParser tool in use", link=images/CalculatorXmindParserTool.png]
...
image::CalculatorNRowsScreenshot.png[CalculatorNRowsScreenshot.png, 800, title="Later version of the calculator to support an unlimited number of rows", link=images/CalculatorNRowsScreenshot.png]
...
image::CalculatorRowTemplate.png[CalculatorRowTemplate.png, 800, title="CalculatorRow abstraction", link=images/CalculatorRowTemplate.png]
...
image::CalculatorNRows.png[CalculatorNRows.png, 800, title="Later version of the calculator to support an unlimited number of rows", link=images/CalculatorNRows.png]
