...
[big]*The rght way to organise code*




image::BOSS_Great_Wall.jpg[BOSS_Great_Wall.jpg,900, title="*The large scale structure of the universe - what should the structure of code look like?*"]
...
In contrast, abstractions are like lego pieces. These pieces are general and can be composed in an infinite variety of ways. A specific arrangement is an explicit artifact in itself. It can be varied without changing the abstractions it uses. 
--
